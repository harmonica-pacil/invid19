    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.each(data, function(ind, dict) {
                ...
                $stack.append('<div class="card"><div class="card-body"><p class="h4">' + comment['message'] + '</p><div class="user"><div class = "image_user"><img src="' + comment['creator_image'] + '" class="rounded float-start" alt=""></div><p class="h6 text-muted">' + comment['creator_username']  + '-' + $a + '</p></div></div></div>');
            });
        }
    });
});