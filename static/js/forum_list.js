    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.each(data, function(ind, dict) {
                ...
                $stack.append('<div class="card" id = "' + dict['pk'] + '"><div class="card-body"><p class="h4">' + forum['title'] + '</p><div class="user"><div class="d-flex flex-column"><div class="container"><div class = "image_user"><img src="' + forum['creator_image'] + '" class="rounded float-start" alt=""></div><p class="h6 text-muted">' + forum['creator_username'] + ' - ' + forum['created_at'] + '</p></div><div class="container"><p class="deskripsi">' + forum['title'] + '</p></div></div></div></div></div>');
            });
        }
    });
});
