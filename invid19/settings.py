"""
Django settings for invid19 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-ouizl1f1$&+qqe#18o_=5jtgi9^io^%l=hq+yl+tvha78jhiot')
...
ALLOWED_HOSTS = [f'https://{HEROKU_APP_NAME}.herokuapp.com']
